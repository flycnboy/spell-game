    ...
    <div className="flex flex-col items-center px-6 py-8 max-w-md mx-auto">
      ...
      {enriched && (
        <div className="w-full bg-gray-50 p-4 rounded-xl mb-6 animate-fade-in text-center">
          <p className="text-2xl font-bold text-gray-800 mb-1">{word.toUpperCase()}</p>
      ...
      {isCorrect ? (
        ...
        <>
          ...
          <p className="text-sm text-gray-400 mb-8">你拼的是：<span className="text-red-500 font-bold">{answer.toUpperCase()}</span></p>
